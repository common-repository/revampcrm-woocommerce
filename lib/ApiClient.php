...
class ApiClient
{
     ...
     */
    public function __construct(\RevampCRM\Client\Configuration $config = null)
    {
        if ($config == null) {
     ...
     *
     * @throws \RevampCRM\Client\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers)) {
            ...
            $postData = json_encode(\RevampCRM\Client\ObjectSerializer::sanitizeForSerialization($postData));  // json_encode
        }
        ...
        if($this->config->getUsername() != null && $this->config->getPassword() != null){
            $options['headers']['Authorization'] = "Basic ". base64_encode($this->config->getUsername() . ":" . $this->config->getPassword());
        ...
        if ($response_code == 0) {
            ...
            // In case of fail having a blank message
            ...
            $exception->setResponseObject($response_code);
            throw $exception;
            ...
            throw new ApiException("[".$response_code."] Error connecting to the API ($url)",
                is_int($response_code)? $response_code:0,
                $http_header,
                $data
            );
        }
