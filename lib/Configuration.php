...
class Configuration
{
     ...
     *
     * @var \RevampCRM\Client\ApiClient
     */
     ...
     * @var string
     */
    protected $host = 'https://app.revampcrm.com:443';
     ...
     * @var string
     */
    protected $userAgent = "";//Swagger-Codegen/0.9.0/php";
    ...
    {
        // WM: Add Basic Auth from start
        //if(!isset($this->defaultHeaders['Authorization'])){
           // $this->defaultHeaders['Authorization'] = "Basic ".base64_encode($this->api_username.":".$this->api_key);
        //}
    ...
    public function getUserAgent()
    {
        ...
        if(empty($this->userAgent)){
            $this->userAgent = 'RevampCRM for WooCommerce/'.$env->version.'; WordPress/'.$env->wp_version;
        }
    ...
    {
        $report  = 'PHP SDK (RevampCRM\Client) Debug Report:' . PHP_EOL;
