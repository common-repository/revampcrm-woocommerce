...
/**
 * DealEditViewModel Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     RevampCRM\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class DealEditViewModel implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'DealEditViewModel';
    ...
    protected static $swaggerTypes = array(
        'product_new' => 'bool',
        'sales_region_new' => 'bool',
        'deal_source_new' => 'bool',
        'mark_as_won' => 'bool',
        '_id' => 'string',
        'account_id' => 'string',
    ...
    protected static $attributeMap = array(
        ...
        'sales_region_new' => 'SalesRegionNew',
        'deal_source_new' => 'DealSourceNew',
        'mark_as_won' => 'MarkAsWon',
        '_id' => '_id',
    ...
    protected static $setters = array(
        'product_new' => 'setProductNew',
        'sales_region_new' => 'setSalesRegionNew',
        'deal_source_new' => 'setDealSourceNew',
        'mark_as_won' => 'setMarkAsWon',
        '_id' => 'setId',
    ...
    protected static $getters = array(
        'product_new' => 'getProductNew',
        'sales_region_new' => 'getSalesRegionNew',
        'deal_source_new' => 'getDealSourceNew',
        'mark_as_won' => 'getMarkAsWon',
        '_id' => 'getId',
    ...
    {
        $this->container['product_new'] = isset($data['product_new']) ? $data['product_new'] : null;
        $this->container['sales_region_new'] = isset($data['sales_region_new']) ? $data['sales_region_new'] : null;
        $this->container['deal_source_new'] = isset($data['deal_source_new']) ? $data['deal_source_new'] : null;
        $this->container['mark_as_won'] = isset($data['mark_as_won']) ? $data['mark_as_won'] : null;
    ...
    {
        return $this->container['product_new'];
    }

    /**
     * Sets product_new
     * @param bool $product_new
     * @return $this
     */
    public function setProductNew($product_new)
    {
        $this->container['product_new'] = $product_new;

        return $this;
    }

    /**
     * Gets sales_region_new
     * @return bool
     */
    public function getSalesRegionNew()
    {
        return $this->container['sales_region_new'];
    }

    /**
     * Sets sales_region_new
     * @param bool $sales_region_new
     * @return $this
     */
    public function setSalesRegionNew($sales_region_new)
    {
        $this->container['sales_region_new'] = $sales_region_new;

        return $this;
    }

    /**
     * Gets deal_source_new
     * @return bool
     */
    public function getDealSourceNew()
    {
        return $this->container['deal_source_new'];
    }

    /**
     * Sets deal_source_new
     * @param bool $deal_source_new
     * @return $this
     */
    public function setDealSourceNew($deal_source_new)
    {
        $this->container['deal_source_new'] = $deal_source_new;
     ...
     * @return bool
     */
    public function getMarkAsWon()
    {
        return $this->container['mark_as_won'];
    }

    /**
     * Sets mark_as_won
     * @param bool $mark_as_won
     * @return $this
     */
    public function setMarkAsWon($mark_as_won)
    {
        $this->container['mark_as_won'] = $mark_as_won;
    ...
    public function setProbability($probability)
    {
        ...
        if ($probability > 100.0) {
            throw new \InvalidArgumentException('invalid value for $probability when calling DealEditViewModel., must be smaller than or equal to 100.0.');
        }
        if ($probability < 0.0) {
            throw new \InvalidArgumentException('invalid value for $probability when calling DealEditViewModel., must be bigger than or equal to 0.0.');
        }
