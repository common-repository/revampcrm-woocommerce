...
/**
 * RelatedCounts Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     RevampCRM\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RelatedCounts implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'RelatedCounts';
    ...
    {
        $this->container['to_do_tasks'] = isset($data['to_do_tasks']) ? $data['to_do_tasks'] : null;
    ...
    {
        return $this->container['to_do_tasks'];
    }

    /**
     * Sets to_do_tasks
     * @param int $to_do_tasks
     * @return $this
     */
    public function setToDoTasks($to_do_tasks)
    {
        $this->container['to_do_tasks'] = $to_do_tasks;
